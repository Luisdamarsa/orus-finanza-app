/**
 * ConfirmDeleteModal.jsx — Modal de confirmación para eliminar transacción
 *
 * Props:
 ...
 *   - title: string - título (defecto: "¿Eliminar transacción?")
...
export default function ConfirmDeleteModal({
  ...
  message = "No se podrá recuperar. Esta acción no se puede deshacer.",
  isDark = false,
}) {
    ...
    <>
      ...
      >
        ...
        >
          ...
          {/* Borrar (rojo - mismo que SaveDeleteButtons) */}
          <button
            onClick={onConfirm}
            style={{
              flex: 1,
