 ...
 * Las secciones aparecen desde abajo al entrar en pantalla (reveal por scroll, IntersectionObserver).
  ...
  return (
    ...
    >
      ...
      <div ref={containerRef}>
        ...
        {/* Donut / pilares */}
        <div className="reveal" style={{ marginTop: 26, display: "flex", flexDirection: "column", alignItems: "center", transitionDelay: ".1s" }}>
        ...
        {/* IA + automatización */}
        <div className="reveal" style={{ ...card, background: "#9B6DFF12", border: "1px solid #9B6DFF44" }}>
          {h("✨", "IA + automatización")}
        ...
        {/* Cierre */}
        <div className="reveal" style={{ textAlign: "center", marginTop: 22, paddingBottom: 10 }}>
